data.dir   <- '/home/shravanthi/Downloads/Face_Detection/'
...
submission
head(submission)
submission <- melt(predictions, id.vars="ImageId", value.name="Location")
head(submission)
submission <- melt(predictions, id.vars="ImageId", variable.name="FeatureName", value.name="Location")
head(submission)
submission <- submission[, sub.col.names]
submission <- submission[, sub.col.FeatureName]
predictions = data.frame(ImageId = 1:nrow(d.test), p)
submission = melt(predictions, id.vars="ImageId", variable.name="FeatureName", value.name="Location")
